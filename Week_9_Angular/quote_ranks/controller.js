...
module.exports = {
    ...
    remove_author: (req, res) => {
        Author.findByIdAndDelete({_id: req.params._id})
            .then(data=>res.json(data))
            .catch(err=>res.json(err))
    ...
    add_quote: (req, res) => {
        ...
        Author.findByIdAndUpdate(req.params._id, { $push: {quotes: req.body}}, {runValidators: true})
            .then(data=>res.json(data))
            .catch(err=>res.json(err))
    ...
    edit_quote: (req, res) => {
        ...
        console.log("Id: ", req.params._id) //quote id
        console.log("edit content ", req.body.content);

        Author.update({quotes: {$elemMatch: { _id : req.params._id }}}, {$set : {"quotes.$.content": req.body.content}}, {runValidators: true})
            .then(data=>res.json(data))
            .catch(err=>res.json(err))
